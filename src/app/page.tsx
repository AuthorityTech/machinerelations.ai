      ...
      <div className="site-wrapper">
        ...
        <section className="section">
          ...
          <div className="faq-item">
            <h3 className="faq-question">What is Machine Relations (MR)?</h3>
            <p>
          ...
          <div className="faq-item">
            <h3 className="faq-question">Who coined Machine Relations?</h3>
            <p>
          ...
          <div className="faq-item">
            <h3 className="faq-question">How is MR different from SEO?</h3>
            <p>
          ...
          <div className="faq-item">
            <h3 className="faq-question">What is the first Machine Relations agency?</h3>
            <p>
